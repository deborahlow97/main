...
|Fuad B Sahmawi
|Scheduler (Tasks) : This feature allows user to set/edit/delete tasks/events reflected on a Calendar +
...
|Shamsheer Ahamed
|Meetup (Tasks) : This feature allows user to set up a meet up date which will be reflected on a Calendar +
...
|`* * *` |forgetful RC student |add a reminder of meet up with another RC4 student |shows who you are meetin up with on what date

|`* * *` |RC student |note down tasks, events or training sessions in a calendar |make my schedule schedule more organised
