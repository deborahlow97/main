...
public class AddCommandSystemTest extends AddressBookSystemTest {
     ...
     * {@code toAdd}.<br>
     * 4. {@code Model}, {@code Storage} and {@code ListPanel} equal to the corresponding components in
     ...
     * 2. {@code Model}, {@code Storage} and {@code ListPanel} equal to the corresponding components in
     ...
     * 4. {@code Model}, {@code Storage} and {@code ListPanel} remain unchanged.<br>
