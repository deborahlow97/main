...
public class CommandTestUtil {
    ...
    public static final String VALID_BIRTHDAY_AMY = "amy@example.com";
    public static final String VALID_BIRTHDAY_BOB = "bob@example.com";
    public static final String VALID_LEVEL_OF_FRIENDSHIP_AMY = "1";
    public static final String VALID_LEVEL_OF_FRIENDSHIP_BOB = "10";
    public static final String VALID_UNIT_NUMBER_AMY = "Block 312, Amy Street 1";
    public static final String VALID_UNIT_NUMBER_BOB = "Block 123, Bobby Street 3";
